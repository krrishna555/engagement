        ...
        <div class="col-xs-5 col-sm-3 col-md-2 sidebar sidebar-left sidebar-animate sidebar-md-show" >
          <ul class="nav navbar-stacked">
                <li class="sidebar-brand">
                    <h4 style="color:white;"><span class="fa fa-home solo"><center>Hello!!</center></span></h4>
                </li>
				 <li <?php if(strripos($_SERVER['REQUEST_URI'],"issueindex.php")) {echo "class='active'";} ?>>
                    <a href="issueindex.php">
                        <span class="fa fa-anchor solo"></span>
                    </a>
                </li>
                <li <?php if(strripos($_SERVER['REQUEST_URI'],"pointpersonindex.php?id=$userid")) {echo "class='active'";} ?>>
                    <a href="pointpersonindex.php?id=<?php echo $userid ?>">
                        <span class="fa fa-anchor solo">Category types</span>
                    </a>
                </li>    					
