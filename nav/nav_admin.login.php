 ...
 <body>
    ...
    <nav class="navbar navbar-default navbar-static-top" style="background-color:#FFFFFF">
      <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../index.php"> <img id="icon" src="../../images/logo.png" alt="logo"></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul id = "navul" class="nav navbar-nav navbar-right" >
		  <li><a href="../login.php" style="background-color:#B01313"><font color="FFFFFF">Login</font></a></li>
