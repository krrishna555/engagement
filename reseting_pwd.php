                            ...
                            <p class="error-message">                                        
								<?php
                                    if(isset($_GET['RES']))
                                    {
                                        ...
                                        else if($_GET['RES']=='UrINacTIVe'){echo "This account is inactive. Contact Admin";}
                                        if($_GET['RES']=='NOuseRiDfOUnd'){echo "Email Address is not found. Make sure you're using the Email Address for your Avon lake Account.";}
                                    }
                                ?>                                       
                             </p>
...
if($new_pwd != $re_pwd){
	...
	$sql_update = "UPDATE users SET password='".md5("$new_pwd")."' WHERE remember_token='".$token."' AND first_name='".$row['first_name']."'";
