   		...
   		<div class="row">
        	<div class="col-md-12">
                     ...
                     <div class="login-container">
                        <h2 class="form-title" align ="center">AVON LAKE</h2>
...
$token = md5("$first_name");
  
$subject = "Avon Lake engagement: Password reset";
$message = "Please click this link to reset your password: https://engagement.emergeinc.com/reseting_pwd.php?u=$first_name&t=$token";
if(mail( "$sendemail", "Avon Lake: Password reset","Please click this link to reset your password: https://engagement.emergeinc.com/reseting_pwd.php?t=$token", "From: engagement@engagement.emergeinc.com
")){
	$sql_token = "UPDATE health_user SET remember_token='".$token."' WHERE first_name='".$first_name."'";
