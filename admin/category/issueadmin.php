...
<a href="addcategoryform.php"><button for="submit_btn" type="submit" id="submit" name="submit" value="SUBMIT" class="btn btn-primary pull-right">Add category</button></a><a href="archivedcategory.php"><button for="submit_btn" type="submit" id="submit" name="submit" value="SUBMIT" class="btn btn-danger pull-right">View Archived category</button></a></br></br>
...
{ ?>
 <td><img height="80" width="130" src="<?php echo $upload_url.'123.png'?>"> </td> <?php
            ...
            <td><a href="addcategory.php?id=<?php echo $row[id]; ?>"><img  src="../../images/editimage.png" width="30" height="30"/></a>&nbsp;&nbsp;<?php if($row['is_active']==0){?> <a class="delete" id="<?php echo $row['id'] ?>">makeactive</a> <?php }?><?php "</td>";
	echo"</tr>";
    }
} else {
    echo "0 results";
