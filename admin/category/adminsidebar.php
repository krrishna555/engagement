                ...
                <li class="sidebar-brand">
				 ...
				 <li <?php if(strripos($_SERVER['REQUEST_URI'],"issueindex.php")) {echo "class='active'";} ?>>
                    <a href="issueindex.php">
                        <span class="fa fa-anchor solo">Issues</span>
                    </a>
                </li>
                <li <?php if(strripos($_SERVER['REQUEST_URI'],"issueadmin.php")) {echo "class='active'";} ?>>
                    <a href="issueadmin.php">
                        <span class="fa fa-anchor solo">Categories</span>
                    </a>
                </li>
                <li <?php if(strripos($_SERVER['REQUEST_URI'],"addusers.php")) {echo "class='active'";} ?>>
                    <a href="addusers.php">
                        <span class="fa fa-anchor solo">Add users</span>
                    </a>
                </li>
